...
class LastAdvertisement extends Component {
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-6">
                        <div className="section-title text-center">
                            <h6 className="sub-title double-line">SO'NGI E'LONLAR</h6>
                        </div>
                    </div>
                </div>
                {
                    lastAdvertisement.map((value, index) => (
                                ...
                                <div className="single-blog-inner">
                                    ...
                                    <div className="details">
                                        <ul className="blog-meta">
                                            ...
                                            <li><i className="fa fa-folder-open-o"/>E'lonlar</li>
                                        </ul>
...
export default LastAdvertisement
